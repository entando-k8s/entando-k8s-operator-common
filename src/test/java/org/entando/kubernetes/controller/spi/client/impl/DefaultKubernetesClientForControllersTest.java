...
class DefaultKubernetesClientForControllersTest extends AbstractK8SIntegrationTest {
    ...
    @Test
    void test_findDepoyment_And_Pod() throws IOException, InterruptedException {
        String ns = "test-entando-k8s-operator-common";
    ...
    @Test
    void test_findDepoyment_And_Pod_Mocked() {
