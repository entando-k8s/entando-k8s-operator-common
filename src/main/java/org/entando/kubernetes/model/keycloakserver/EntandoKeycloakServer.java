...
@Group("entando.org")
@Version("v1")
public class EntandoKeycloakServer extends EntandoBaseCustomResource<EntandoKeycloakServerSpec, EntandoCustomResourceStatus> implements SpecHasIngress {

    @Override
    public String getCRDName() {
        return super.getCRDName();
    }
